...
public class Flyer : MonoBehaviour {
    ...
    private void Update() {
        ...
        if ((selfPosition - flyTarget).magnitude < 0.1f) {
            IdleFly();
        }
    }
    ...
    public void IdleFly() {
        ...
        flyTarget = new Vector3(
            selfPosition.x + UnityEngine.Random.Range(-idleFlyRandomness, idleFlyRandomness),
            selfPosition.y + UnityEngine.Random.Range(-idleFlyRandomness, idleFlyRandomness),
            selfPosition.z
        );
    }
